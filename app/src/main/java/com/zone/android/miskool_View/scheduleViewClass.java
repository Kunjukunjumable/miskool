...
//          args.putInt(CaldroidFragment.THEME_RESOURCE, com.caldroid.R.style.CaldroidDefaultDark);
        ...
        final CaldroidListener listener = new CaldroidListener() {
            ...
            public void onSelectDate(Date date, View view) {
             //   Toast.makeText(getApplicationContext(), formatter.format(date),
                ...
                lastSelDate=seldate;
                Log.e("lastSelDateclick "," lastSelDateClick "+lastSelDate);
               ...
               String studentname= studentPreference.getString("studentname", "");
                ...
                Log.e("getSelonSelectDate ","getSelonSelectDate "+seldate);
    ...
    public void setMessages(List<Schedule> scheduleList) {
        ...
        Log.e("scheduleList", "scheduleList111 : " + scheduleList.size());
    ...
    public void setSelEvents(List<Schedule> scheduleList) {
        ...
        Log.e("eventsSize ","eventsSize "+scheduleList.size());
        scheduleList.size();
...
runOnUiThread(new Runnable() {
    ...
    private class listAsyns extends AsyncTask<Void, Void, Void> {
       ...
       private   List<Schedule>schedules;
        ...
        protected Void doInBackground(Void... voids) {
            ...
            Log.e("schedules.size() ","schedules.size() "+schedules.size());



            for(int i=0;i<schedules.size();i++){
                Log.e("schedules.date","schedules.date"+schedules.get(i).getStarttime());
            ...
            for(int i=0;i<schedules.size();i++){
                ...
                Log.e("datesSize ","datesSize "+dates.size());
                    ...
                    for (Date date : dates) {
                        ...
                        Log.e("dateFormatted ", "day  "+day+" month "+month+" year "+year + dateFormatted +" counter "+counter++);
        ...
        protected void onPostExecute(Void aVoid) {
           ...
           // progressBar.dismiss();
            ...
            Log.e("getSelPostExecute ","getSelPostExecute "+finaldate);
    ...
    public void sentUpresponse(String Student_id, Schedule schedule) {
        Log.e("sentUpresponse ","sentUpresponse ");
       ...
       //need to check if new or edit
        ...
        imgSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e("starttime","starttime "+ starttime+" "+endtime);
