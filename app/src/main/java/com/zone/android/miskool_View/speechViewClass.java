...
List<Speech> speechList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ed_replycontent.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                ...
                Log.e("TextChangedBefore ","TextChangedBefore "+s);
            }

            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {

                Log.e("TextChangedOn ","TextChangedOn "+s);
            ...
            public void afterTextChanged(Editable s) {
                ...
                Log.e("afterTextChanged ", "afterTextChanged " + s.length());
    ...
    public void setMessages(List<Speech> speechList) {
        ...
        Log.e("speechList ","speechList "+speechList.size());
