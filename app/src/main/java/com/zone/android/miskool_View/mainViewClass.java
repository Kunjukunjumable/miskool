...
//////////////////////////////ending yalantis menu here
        ...
        Log.e("prefstudentnameCreate ", "prefstudentnameCreate " + studentname + " " + studentId);
...
*/
    ...
    protected void onResume() {
        ...
        Log.e("preftudentnameResume ", "prefstudentnameResume " + studentname + " " + studentId);
    ...
    protected void onStart() {
        ...
        Log.e("preftudentnameStart ", "preftudentnameStart " + studentname + " " + studentId);
...
*/
        //Log.e("personList1 ","personList1 "+personList1.size());


        String Fruits[] = {"Mable", "Abin", "Anju", "Soniya", "Merin"};
...
*/
    ...
    void screenHeight() {
        ...
        Log.e("dpHeight", "dpHeight  " + dpHeight);
        ...
        try {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Log.e("alertListSize ", "alertListSize " + alertList.size());
